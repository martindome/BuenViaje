...
namespace BuenViaje.Localidades
{
    public partial class ABMLocalidades : Form
    {
        ...
        public ABMLocalidades()
        {
            ...
            ABMLocalidadesTexto1.HelpRequested += new HelpEventHandler(textBox_HelpRequested);
            ABMLocalidadesTexto2.HelpRequested += new HelpEventHandler(textBox_HelpRequested);
            ABMLocalidadesTexto3.HelpRequested += new HelpEventHandler(textBox_HelpRequested);
